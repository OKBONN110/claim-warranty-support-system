  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="claim-reference-banner mt-6 rounded-3xl p-7 text-white">
              ...
              >
                {isStaff ? (
                  <label className="mb-4 block text-sm font-semibold text-[#0D2347]">
                    ...
                    <select
                      name="message_type"
                      defaultValue="public"
                      className="mt-2 w-full rounded-xl border border-[#CBD4E0] bg-[#F1F3F5] px-4 py-3 text-[#0D2347] outline-none focus:border-[#BF1A2F] focus:bg-white focus:ring-4 focus:ring-[#BF1A2F]/10"
                    >
                      <option value="public">
                        Public reply
                      </option>
                ...
                <label className="block text-sm font-semibold text-[#0D2347]">
                  ...
                  <textarea
                    ...
                    className="mt-2 w-full rounded-xl border border-[#CBD4E0] bg-[#F1F3F5] px-4 py-3 text-[#0D2347] outline-none placeholder:text-[#A4ADB9] focus:border-[#BF1A2F] focus:bg-white focus:ring-4 focus:ring-[#BF1A2F]/10"
                  />
                </label>
